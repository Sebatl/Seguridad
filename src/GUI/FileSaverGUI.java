...
public class FileSaverGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fileSelector.setDialogType(javax.swing.JFileChooser.SAVE_DIALOG);
    ...
    private void fileSelectorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileSelectorActionPerformed
        ...
        try {
            System.out.println("File selected: "+fileSelector.getSelectedFile().getName());
            ...
            Logger.getLogger(FileSaverGUI.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileSaverGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FileSaverGUI().setVisible(true);
            }
        });
    }
